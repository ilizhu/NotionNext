...
const BLOG = {
  ...
  APPEARANCE_DARK_TIME: process.env.NEXT_PUBLIC_APPEARANCE_DARK_TIME || [18, 5], // 夜间模式起至时间，false时关闭根据时间自动切换夜间模式
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Z', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://110.im', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '妖妖灵博客, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'x@110.im', // 邮箱地址 例如mail@tangly1024.com
